<div class="pt-2">
            <form id="formRegistraCliente" class="formFacturaCompra pt-2 pb-2">
                    <div class="col-12">
                        <h4>DNI</h4>
                ...
                <div class="cajaBotonProducto">
                    <input type="submit" id="botonRegistraCliente" name="botonRegistraCliente" class="boton1 col-12" value="Añadir">
            </div>
            </form>
